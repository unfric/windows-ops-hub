...
const OrdersDashboard = lazyWithRetry(() => import("@/pages/OrdersDashboard"));
...
const InstallationPage = lazyWithRetry(() => import("@/pages/InstallationPage"));
const ReworkPage = lazyWithRetry(() => import("@/pages/ReworkPage"));
...
const GeneralSettingsPage = lazyWithRetry(() => import("@/pages/settings/GeneralSettingsPage"));
const MastersSettingsPage = lazyWithRetry(() => import("@/pages/settings/MastersSettingsPage"));
